...
preguntas[1] = new pregunta("(2) ¿Para qué se utiliza el álgebra booleana?","A) Para modelar los circuitos de dispositivos electrónicos.","B) Para modelar circuitos magnéticos.","C) Para modelar los circuitos de dispositivos mecánicos.","D) Para modelar circuitos hidráulicos", 1);
preguntas[2] = new pregunta("(3) ¿Método más efectivo para resolver la minimización de funciones booleanas con más de 6 variables?","A) Minimización por Quine-McCluskey","B) Tablas de verdad","C) Minimización por mapas de Karnaugh","D) Tablas de implicantes primos esenciales", 1);
...
preguntas[4] = new pregunta("(5) ¿Qué es la forma canónica disyuntiva?","A) La suma de todos los Minterms","B) La suma de todos los Minterms y Maxterms","C) La suma de todos los Maxterms","D) La suma de todas las funciones booleanas", 1);
...
preguntas[7] = new pregunta("(8) ¿Qué es la forma canónica conjuntiva?","A) La suma de todos los Minterms","B) La suma de todos los Minterms y Maxterms","C) La suma de todos los Maxterms","D) La suma de todas las funciones booleanas", 2);
...
preguntas[11] = new pregunta("(12) Propiedad del álgebra de Boole que permite que el primer y segundo lugar se inviertan sin alterar el resultado.","A) Propiedad del inverso.","B) Propiedad conmutativa.","C) Propiedad de cambio.","D) Propiedad del elemento neutro.", 2);
...
preguntas[13] = new pregunta("(14) Circuitos que producen una salida que depende solo de la entrada y no del estado actual del circuito.","A) Redes lógicas.","B) Circuitos de operación neutra","C) Redes combinacionales","D) Circuitos cerrados", 1);
...
preguntas[15] = new pregunta("(16) Escoge la opción que contenga solo puertas lógicas.","A) OR, IN.","B) OR, AND, NOT.","C) FOR, AND.","D) AND, OR, THIS.", 2);
...
preguntas[17] = new pregunta("(18) La eficiencia de un circuito _________ depende del número de ______ que tenga y de la disposición de estas.","A) Combinacional, combinaciones.","B) Combinacional, puertas.","C) De entrada, puertas.","D) De salida, combinaciones.", 2);
preguntas[18] = new pregunta("(19) Procedimiento desarrollado en los cincuenta para ayudar a minimizar circuitos de forma manual.","A) Diagramas de Karnaugh.","B) Diagrama descriptivo.","C) Diagrama minimizador.","D) Diagrama simple.", 1);
...
preguntas[23] = new pregunta("(24) ¿Qué variables booleanas representan el número binario 1010?","A) .𝐴𝐵𝐶𝐷","B) A-C-.","C) 𝐴𝐵𝐶𝐷","D) -A-C.", 2);
preguntas[24] = new pregunta("(25) ¿Qué expresión representa un maxitérmino?","A) .𝑥𝑦𝑧","B) 𝑥𝑦𝑧 + 𝑥𝑦𝑧","C) .𝑥𝑦𝑧 + 𝑥𝑦𝑧 + 𝑥𝑦𝑧 + 𝑥𝑦","D) .𝑥𝑦", 1);
preguntas[25] = new pregunta("(26) ¿Qué expresión representa un minitérmino?","A) 𝐼𝐽𝐾","B) .𝐼𝐽","C) .𝐼𝐽𝐾 + 𝐼𝐽𝐾","D) .𝐼𝐽𝐾 + 𝐼𝐽 + 𝐼𝐽𝐾 + 𝐼𝐽𝐾", 0);
preguntas[26] = new pregunta("(27) Expresión que representa la propiedad del álgebra de Boole Acotación.","A) .(𝐴 + 𝐵) + 1 = 0","B) .(𝐴 + 𝐵) · 0 = 1","C) (𝐴 + 𝐵) + 1 = 1","D) .(𝐴 + 𝐵) · 1 = 1", 2);
preguntas[27] = new pregunta("(28) ¿Cuántas redes lógicas pueden ingresar a una puerta lógica en un circuito?","A) Menos de cuatro.","B) Cuatro.","C) Más de cuatro.","D) Entre una y cuatro.", 2);
preguntas[28] = new pregunta("(29) Con ayuda del álgebra de Boole, seleccione la minimización correcta de la expresión booleana 𝑥𝑦𝑧 + 𝑥𝑦𝑧","A) .𝑥𝑧","B) 𝑥𝑧","C) .𝑥𝑧","D) 𝑥𝑧", 1);
...
preguntas[39] = new pregunta("(40) ¿Qué número decimal representa el número binomial 100?", "A) 5", "B) 2", "C) 4", "D) 3", 2);
...
preguntas[42] = new pregunta("(43) Se le llama minimización booleana a:", "A) Al proceso de obtener restas", "B) Al proceso de obtener divisiones", "C) Al proceso de obtener productos", "D) Al proceso de obtener restas menores", 2);
...
preguntas[49] = new pregunta("(50) Significado de las siglas IBM.", "A) International Business Machines", "B) International of Build and Maintenance", "C) Imagination Business Machines", "D) International Business Maintenance", 0);
